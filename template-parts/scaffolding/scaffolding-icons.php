...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'icons', 'territory-theme' ); ?>"><?php esc_html_e( 'Icons', 'territory-theme' ); ?></h2>
	...
	territory_theme_display_scaffolding_section(
		[
			...
			'usage'       => '<?php territory_theme_display_svg( array(
			...
			'output'      => territory_theme_get_svg(
				[
					'icon'   => 'facebook-square',
					'title'  => 'Facebook Icon',
					'desc'   => 'Facebook social icon svg',
