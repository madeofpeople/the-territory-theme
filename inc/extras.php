 ...
 */
function territory_theme_categorized_blog() {
	$category_count = get_transient( 'territory_theme_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'territory_theme_categories', $category_count );
	}
 ...
 */
function territory_theme_get_attachment_id_from_url( $attachment_url = '' ) {
	global $wpdb;
 ...
 */
function territory_theme_copyright_year( $atts ) {
	// Setup defaults.
	$args = shortcode_atts(
		[
			'starting_year' => '',
...
add_shortcode( 'territory_theme_copyright_year', 'territory_theme_copyright_year', 15 );
 ...
 */
function territory_theme_get_custom_logo_url() {
