 ...
 */
function territory_theme_scripts() {
...
add_action( 'wp_enqueue_scripts', 'territory_theme_scripts' );
 ...
 */
function territory_theme_critical_css() {
	?>
	<style>
...
add_action( 'wp_head', 'territory_theme_critical_css', 1 );
 ...
 * @author WebDevStudios
 */
function territory_theme_preload_scripts() {
	$asset_file_path = dirname( __DIR__ ) . '/build/index.asset.php';
...
add_action( 'wp_head', 'territory_theme_preload_scripts', 1 );
 ...
 * @author Corey Collins
 */
function territory_theme_preload_assets() {
	?>
	<?php if ( territory_theme_get_custom_logo_url() ) : ?>
		<link rel="preload" href="<?php echo esc_url( territory_theme_get_custom_logo_url() ); ?>" as="image">
	<?php endif; ?>
	<?php
}
add_action( 'wp_head', 'territory_theme_preload_assets', 1 );
