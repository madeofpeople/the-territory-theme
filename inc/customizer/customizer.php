 ...
 */
function territory_theme_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'territory_theme_remove_default_customizer_sections', 15 );
 ...
 */
function territory_theme_include_custom_controls() {
...
add_action( 'customize_register', 'territory_theme_include_custom_controls', -999 );
 ...
 * @author WebDevStudios
 */
function territory_theme_customize_scripts() {
	wp_enqueue_script( 'territory-theme-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
add_action( 'customize_preview_init', 'territory_theme_customize_scripts' );
 ...
 */
function territory_theme_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = [
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'territory_theme_copyright_text' => '.site-info',
	];
...
add_action( 'customize_register', 'territory_theme_selective_refresh_support' );
 ...
 */
function territory_theme_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'territory_theme_live_preview_support', 999 );
